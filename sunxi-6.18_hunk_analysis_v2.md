...
**Analysis Date:** 2025-12-07 04:37:53
...
| media-cedrus-Implement-AFBC-YUV420-formats-for-H265.patch | `drivers/staging/media/sunxi/cedrus/cedrus_hw.c` | #4 | +4/-0 | Patch not applied (found before-state, patch still needed) |
...
| media-ov5640-Implement-autofocus.patch | `drivers/media/i2c/ov5640.c` | #10 | +6/-0 | Patch not applied (found before-state, patch still needed) |
...
- Only 401 enabled patches were analyzed
