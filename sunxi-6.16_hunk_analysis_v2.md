...
**Analysis Date:** 2025-12-07 04:39:02

## Summary

- **Total Hunks:** 1735
- **Found in Kernel:** 17 (0%)
- **Not Found:** 1718 (99%)
- **Patches Analyzed:** 443
- **Patches Enabled:** 443
- **Patches Disabled:** 1
...
|------------|------|------|-------|-------|-------|
| Move-a-node-to-avoid-merge-conflict.patch | `arch/arm/boot/dts/allwinner/sunxi-h3-h5.dtsi` | #2 | +6/-0 | ✓ | Patch appears to be already applied (found after-state with context) |
| Move-a-node-to-avoid-merge-conflict.patch | `arch/arm64/boot/dts/allwinner/sun50i-h6-orangepi-3.dts` | #4 | +0/-4 | ✓ | Patch appears to be already applied (found after-state with context) |
| Move-a-node-to-avoid-merge-conflict.patch | `arch/arm64/boot/dts/allwinner/sun50i-h6.dtsi` | #5 | +0/-14 | ✓ | Patch appears to be already applied (found after-state with context) |
| Revert-usb-typec-tcpm-unregister-existing-source-caps-before-re.patch | `drivers/usb/typec/tcpm/tcpm.c` | #1 | +1/-1 | ✓ | Patch appears to be already applied (found after-state with context) |
...
| media-gc2145-Galaxycore-camera-module-driver.patch | `drivers/media/i2c/gc2145.c` | #3 | +2252/-1 | ✓ | Added lines found (uncertain - minimal context) |
| media-ov5640-Fix-focus-commands-blocking-until-complete.patch | `drivers/media/i2c/ov5640.c` | #3 | +0/-29 | ✓ | Patch appears to be already applied (found after-state with context) |

## Not Found Hunks (Sample - First 50)

| Patch File | File | Hunk | Lines | Notes |
|------------|------|------|-------|-------|
| media-cedrus-add-format-filtering-based-on-depth-and-src-format.patch | `drivers/staging/media/sunxi/cedrus/cedrus_video.c` | #1 | +7/-0 | Patch not applied (found before-state, patch still needed) |
| media-cedrus-add-format-filtering-based-on-depth-and-src-format.patch | `drivers/staging/media/sunxi/cedrus/cedrus_video.h` | #2 | +2/-1 | Could not determine patch state reliably |
| media-Add-NV12-and-P010-AFBC-compressed-formats.patch | `drivers/media/v4l2-core/v4l2-ioctl.c` | #1 | +2/-0 | Patch not applied (found before-state, patch still needed) |
| media-Add-NV12-and-P010-AFBC-compressed-formats.patch | `include/uapi/linux/videodev2.h` | #2 | +4/-1 | Could not determine patch state reliably |
| media-cedrus-Implement-AFBC-YUV420-formats-for-H265.patch | `drivers/staging/media/sunxi/cedrus/cedrus.h` | #1 | +11/-0 | Patch not applied (found before-state, patch still needed) |
| media-cedrus-Implement-AFBC-YUV420-formats-for-H265.patch | `drivers/staging/media/sunxi/cedrus/cedrus_h265.c` | #2 | +2/-1 | Patch not applied (found before-state, patch still needed) |
| media-cedrus-Implement-AFBC-YUV420-formats-for-H265.patch | `drivers/staging/media/sunxi/cedrus/cedrus_hw.c` | #3 | +12/-0 | Patch not applied (found before-state, patch still needed) |
| media-cedrus-Implement-AFBC-YUV420-formats-for-H265.patch | `drivers/staging/media/sunxi/cedrus/cedrus_hw.c` | #4 | +4/-0 | Could not determine patch state reliably |
| media-cedrus-Implement-AFBC-YUV420-formats-for-H265.patch | `drivers/staging/media/sunxi/cedrus/cedrus_regs.h` | #5 | +6/-0 | Patch not applied (found before-state, patch still needed) |
| media-cedrus-Implement-AFBC-YUV420-formats-for-H265.patch | `drivers/staging/media/sunxi/cedrus/cedrus_video.c` | #6 | +16/-0 | Patch not applied (found before-state, patch still needed) |
| media-cedrus-Implement-AFBC-YUV420-formats-for-H265.patch | `drivers/staging/media/sunxi/cedrus/cedrus_video.c` | #7 | +20/-1 | Could not determine patch state reliably |
| dma-sun6i-dma-add-sun50i-h616-support.patch | `drivers/dma/sun6i-dma.c` | #1 | +22/-0 | Patch not applied (found before-state, patch still needed) |
| dma-sun6i-dma-add-sun50i-h616-support.patch | `drivers/dma/sun6i-dma.c` | #2 | +1/-1 | Could not determine patch state reliably |
| media-cedrus-Increase-H6-clock-rate.patch | `drivers/staging/media/sunxi/cedrus/cedrus.c` | #1 | +1/-2 | Could not determine patch state reliably |
| media-cedrus-Don-t-CPU-map-source-buffers.patch | `drivers/staging/media/sunxi/cedrus/cedrus_video.c` | #1 | +1/-1 | Could not determine patch state reliably |
| net-stmmac-sun8i-Use-devm_regulator_get-for-PHY-regulator.patch | `drivers/net/ethernet/stmicro/stmmac/dwmac-sun8i.c` | #1 | +4/-6 | Patch not applied (found before-state, patch still needed) |
| net-stmmac-sun8i-Use-devm_regulator_get-for-PHY-regulator.patch | `drivers/net/ethernet/stmicro/stmmac/dwmac-sun8i.c` | #2 | +1/-2 | Patch not applied (found before-state, patch still needed) |
| net-stmmac-sun8i-Use-devm_regulator_get-for-PHY-regulator.patch | `drivers/net/ethernet/stmicro/stmmac/dwmac-sun8i.c` | #3 | +1/-2 | Patch not applied (found before-state, patch still needed) |
| net-stmmac-sun8i-Use-devm_regulator_get-for-PHY-regulator.patch | `drivers/net/ethernet/stmicro/stmmac/dwmac-sun8i.c` | #4 | +4/-8 | Could not determine patch state reliably |
| mmc-add-delay-after-power-class-selection.patch | `drivers/mmc/core/mmc.c` | #1 | +2/-0 | Patch not applied (found before-state, patch still needed) |
| mmc-add-delay-after-power-class-selection.patch | `drivers/mmc/core/mmc.c` | #2 | +2/-1 | Could not determine patch state reliably |
| ARM-dts-sun8i-a83t-tbs-a711-Add-powerup-down-support-for-the-3G.patch | `arch/arm/boot/dts/allwinner/sun8i-a83t-tbs-a711.dts` | #1 | +1/-1 | Patch not applied (found before-state, patch still needed) |
| ARM-dts-sun8i-a83t-tbs-a711-Add-powerup-down-support-for-the-3G.patch | `arch/arm/boot/dts/allwinner/sun8i-a83t-tbs-a711.dts` | #2 | +11/-1 | Could not determine patch state reliably |
...
| arm64-dts-sun50i-a64-pinephone-Add-support-for-modem-audio.patch | `arch/arm64/boot/dts/allwinner/sun50i-a64-pinephone.dtsi` | #1 | +6/-0 | Could not determine patch state reliably |
| arm64-dts-sun50i-a64-pinephone-Add-support-for-modem-audio.patch | `arch/arm64/boot/dts/allwinner/sun50i-a64-pinephone.dtsi` | #2 | +1/-1 | Patch not applied (found before-state, patch still needed) |
| arm64-dts-sun50i-a64-pinephone-Add-support-for-modem-audio.patch | `arch/arm64/boot/dts/allwinner/sun50i-a64-pinephone.dtsi` | #3 | +17/-1 | Could not determine patch state reliably |
| media-ov5640-Implement-autofocus.patch | `drivers/media/i2c/ov5640.c` | #1 | +1/-0 | Patch not applied (found before-state, patch still needed) |
| media-ov5640-Implement-autofocus.patch | `drivers/media/i2c/ov5640.c` | #2 | +32/-0 | Patch not applied (found before-state, patch still needed) |
| media-ov5640-Implement-autofocus.patch | `drivers/media/i2c/ov5640.c` | #3 | +6/-0 | Patch not applied (found before-state, patch still needed) |
| media-ov5640-Implement-autofocus.patch | `drivers/media/i2c/ov5640.c` | #4 | +2/-0 | Patch not applied (found before-state, patch still needed) |
| media-ov5640-Implement-autofocus.patch | `drivers/media/i2c/ov5640.c` | #5 | +112/-0 | Patch not applied (found before-state, patch still needed) |
| media-ov5640-Implement-autofocus.patch | `drivers/media/i2c/ov5640.c` | #6 | +3/-0 | Patch not applied (found before-state, patch still needed) |
| media-ov5640-Implement-autofocus.patch | `drivers/media/i2c/ov5640.c` | #7 | +29/-0 | Patch not applied (found before-state, patch still needed) |
| media-ov5640-Implement-autofocus.patch | `drivers/media/i2c/ov5640.c` | #8 | +35/-0 | Patch not applied (found before-state, patch still needed) |
| media-ov5640-Implement-autofocus.patch | `drivers/media/i2c/ov5640.c` | #9 | +26/-0 | Patch not applied (found before-state, patch still needed) |
| media-ov5640-Implement-autofocus.patch | `drivers/media/i2c/ov5640.c` | #10 | +6/-0 | Could not determine patch state reliably |
| media-ov5640-Implement-autofocus.patch | `drivers/media/i2c/ov5640.c` | #11 | +12/-0 | Patch not applied (found before-state, patch still needed) |
| media-ov5640-Implement-autofocus.patch | `drivers/media/i2c/ov5640.c` | #12 | +14/-0 | Patch not applied (found before-state, patch still needed) |
| media-ov5640-Implement-autofocus.patch | `drivers/media/i2c/ov5640.c` | #13 | +1/-1 | Could not determine patch state reliably |
| power-supply-axp20x-battery-Improve-probe-error-reporting.patch | `drivers/power/supply/axp20x_battery.c` | #1 | +5/-6 | Could not determine patch state reliably |
| power-supply-axp20x-battery-Improve-probe-error-reporting.patch | `drivers/power/supply/axp20x_battery.c` | #2 | +7/-11 | Could not determine patch state reliably |
| arm64-dts-sun50i-a64-pinephone-Use-newer-jack-detection-impleme.patch | `arch/arm64/boot/dts/allwinner/sun50i-a64-pinephone.dtsi` | #1 | +1/-0 | Could not determine patch state reliably |
| arm64-dts-sun50i-a64-pinephone-Use-newer-jack-detection-impleme.patch | `arch/arm64/boot/dts/allwinner/sun50i-a64-pinephone.dtsi` | #2 | +1/-2 | Could not determine patch state reliably |
| arm64-dts-sun50i-a64-pinephone-Fix-BH-modem-manager-behavior.patch | `arch/arm64/boot/dts/allwinner/sun50i-a64-pinephone-1.1.dts` | #1 | +2/-3 | Could not determine patch state reliably |
| arm64-dts-allwinner-h5-Enable-hdmi-sound-card-on-boards-with-hd.patch | `arch/arm64/boot/dts/allwinner/sun50i-h5-emlid-neutis-n5-devboard.dts` | #1 | +8/-0 | Patch not applied (found before-state, patch still needed) |
| arm64-dts-allwinner-h5-Enable-hdmi-sound-card-on-boards-with-hd.patch | `arch/arm64/boot/dts/allwinner/sun50i-h5-orangepi-pc2.dts` | #2 | +4/-0 | Patch not applied (found before-state, patch still needed) |
| arm64-dts-allwinner-h5-Enable-hdmi-sound-card-on-boards-with-hd.patch | `arch/arm64/boot/dts/allwinner/sun50i-h5-orangepi-pc2.dts` | #3 | +4/-0 | Patch not applied (found before-state, patch still needed) |
| arm64-dts-allwinner-h5-Enable-hdmi-sound-card-on-boards-with-hd.patch | `arch/arm64/boot/dts/allwinner/sun50i-h5-orangepi-prime.dts` | #4 | +4/-0 | Patch not applied (found before-state, patch still needed) |
| arm64-dts-allwinner-h5-Enable-hdmi-sound-card-on-boards-with-hd.patch | `arch/arm64/boot/dts/allwinner/sun50i-h5-orangepi-prime.dts` | #5 | +4/-0 | Patch not applied (found before-state, patch still needed) |

*... and 1668 more hunks not found*
...
| ARM-dts-sun8i-a83t-Add-hdmi-sound-card.patch | 2 | 0 | 2 | 0% |
| ARM-dts-sun8i-a83t-Add-missing-GPU-trip-point.patch | 1 | 0 | 1 | 0% |
...
| ARM-dts-sun8i-a83t-tbs-a711-Add-camera-sensors-HM5065-GC2145.patch | 6 | 0 | 6 | 0% |
...
| ARM-dts-sun8i-a83t-tbs-a711-Give-Linux-more-privileges-over-SCP.patch | 3 | 0 | 3 | 0% |
...
| ARM-dts-sun8i-h3-orange-pi-one-Enable-all-gpio-header-UARTs.patch | 2 | 0 | 2 | 0% |
...
| ARM-dts-sun8i-r40-Add-hdmi-sound-card.patch | 2 | 0 | 2 | 0% |
...
| ARM-dts-sunxi-h3-h5-Add-hdmi-sound-card.patch | 2 | 0 | 2 | 0% |
...
| ARM-sunxi-sunxi_cpu0_hotplug_support_set-is-not-supported-on-A8.patch | 1 | 0 | 1 | 0% |
...
| Add-support-for-my-private-Sapomat-device.patch | 2 | 0 | 2 | 0% |
| Add-wifi-nodes-for-Inovato-Quadra.patch | 2 | 0 | 2 | 0% |
...
| LED-green_power_on-red_status_heartbeat-arch-arm64-boot-dts-all.patch | 1 | 0 | 1 | 0% |
...
| Move-a-node-to-avoid-merge-conflict.patch | 6 | 3 | 3 | 50% |
...
| arm-dts-overlay-Add-Overlays-for-sunxi.patch | 97 | 0 | 97 | 0% |
...
| arm-dts-sun7i-a20-olimex-som-204-evb-olinuxino-micro-decrease-d.patch | 3 | 0 | 3 | 0% |
| arm-dts-sun7i-a20-olinuxino-lime2-enable-audio-codec.patch | 1 | 0 | 1 | 0% |
| arm-dts-sun7i-a20-olinuxino-lime2-enable-ldo3-always-on.patch | 1 | 0 | 1 | 0% |
...
| arm-patch-call-flush_icache-ASAP-after-writing-new-instruction.patch | 1 | 0 | 1 | 0% |
| arm64-allwinner-Add-sun50i-h618-bananapi-m4-berry-support.patch | 3 | 0 | 3 | 0% |
| arm64-allwinner-dts-a64-enable-K101-IM2BYL02-panel-for-PineTab.patch | 1 | 0 | 1 | 0% |
| arm64-dts-Add-sun50i-h5-nanopi-k1-plus-device.patch | 2 | 0 | 2 | 0% |
| arm64-dts-Add-sun50i-h5-nanopi-m1-plus2-device.patch | 2 | 0 | 2 | 0% |
| arm64-dts-Add-sun50i-h5-nanopi-neo-core2-device.patch | 2 | 0 | 2 | 0% |
| arm64-dts-Add-sun50i-h5-nanopi-neo2-v1.1-device.patch | 2 | 0 | 2 | 0% |
...
| arm64-dts-allwinner-a64-Add-hdmi-sound-card.patch | 2 | 0 | 2 | 0% |
...
| arm64-dts-allwinner-h6-Add-hdmi-sound-card.patch | 3 | 0 | 3 | 0% |
...
| arm64-dts-allwinner-overlay-Add-Overlays-for-sunxi64.patch | 49 | 0 | 49 | 0% |
...
| arm64-dts-sun50i-a64-olinuxino-add-boards.patch | 6 | 0 | 6 | 0% |
...
| arm64-dts-sun50i-a64-pinephone-Add-support-for-Pinephone-1.2-be.patch | 2 | 0 | 2 | 0% |
...
| arm64-dts-sun50i-a64-pinephone-Enable-internal-HMIC-bias.patch | 1 | 0 | 1 | 0% |
...
| arm64-dts-sun50i-a64-sopine-baseboard-mmc1-status-okay.patch | 1 | 0 | 1 | 0% |
| arm64-dts-sun50i-a64.dtsi-adjust-thermal-trip-points.patch | 1 | 0 | 1 | 0% |
| arm64-dts-sun50i-h313-x96q-lpddr3.patch | 3 | 0 | 3 | 0% |
...
| arm64-dts-sun50i-h5-orangepi-prime-add-regulator.patch | 4 | 0 | 4 | 0% |
...
| arm64-dts-sun50i-h6-Add-r_uart-uart2-3-pins.patch | 6 | 0 | 6 | 0% |
...
| arm64-dts-sun50i-h6-pine-h64-add-wifi-rtl8723cs.patch | 3 | 0 | 3 | 0% |
...
| arm64-dts-sun50i-h616-bigtreetech-cb1-sd-emmc.patch | 13 | 0 | 13 | 0% |
| arm64-dts-sun50i-h616-orangepi-zero2-Enable-GPU-mali.patch | 1 | 0 | 1 | 0% |
| arm64-dts-sun50i-h616-orangepi-zero2-reg_usb1_vbus-status-ok.patch | 1 | 0 | 1 | 0% |
...
| arm64-dts-sun50i-h618-orangepi-zero3-Enable-GPU-mali.patch | 1 | 0 | 1 | 0% |
...
| bluetooth-h5-Don-t-re-initialize-rtl8723cs-on-resume.patch | 1 | 0 | 1 | 0% |
...
| dma-sun6i-dma-add-sun50i-h616-support.patch | 2 | 0 | 2 | 0% |
...
| drv-gpu-drm-gem-dma-Export-with-handle-allocator.patch | 3 | 0 | 3 | 0% |
...
| drv-gpu-drm-sun4i-sun8i_mixer.c-add-h3-mixer1.patch | 2 | 0 | 2 | 0% |
...
| drv-nvmem-sunxi_sid-Support-SID-on-H616.patch | 2 | 0 | 2 | 0% |
| drv-of-Device-Tree-Overlay-ConfigFS-interface.patch | 4 | 0 | 4 | 0% |
...
| drv-spi-spi-sun4i.c-spi-bug-low-on-sck.patch | 2 | 0 | 2 | 0% |
| drv-spi-spidev-Add-armbian-spi-dev-compatible.patch | 2 | 0 | 2 | 0% |
| drv-staging-media-sunxi-cedrus-add-H616-variant.patch | 2 | 0 | 2 | 0% |
...
| media-gc2145-Add-PIXEL_RATE-HBLANK-and-VBLANK-controls.patch | 8 | 0 | 8 | 0% |
...
| media-i2c-gc2145-Parse-and-register-properties.patch | 2 | 0 | 2 | 0% |
...
| media-ov5640-Fix-focus-commands-blocking-until-complete.patch | 4 | 1 | 3 | 25% |
...
| media-ov5648-Fix-call-to-pm_runtime_set_suspended.patch | 1 | 0 | 1 | 0% |
| media-sun6i-csi-Add-multicamera-support-for-parallel-bus.patch | 10 | 0 | 10 | 0% |
...
| media-sun6i-csi-merge-sun6i_csi_formats-and-sun6i_csi_formats_m.patch | 8 | 0 | 8 | 0% |
...
| net-stmmac-sun8i-Use-devm_regulator_get-for-PHY-regulator.patch | 4 | 0 | 4 | 0% |
...
| pci-Workaround-ITS-timeouts-on-poweroff-reboot-on-Orange-Pi-5-P.patch | 1 | 0 | 1 | 0% |
...
| power-supply-axp20x-battery-Add-support-for-POWER_SUPPLY_PROP_E.patch | 5 | 0 | 5 | 0% |
...
| power-supply-axp20x-battery-Support-POWER_SUPPLY_PROP_CHARGE_BE.patch | 5 | 0 | 5 | 0% |
...
| sound-soc-sunxi-Provoke-the-early-load-of-sun8i-codec-analog.patch | 1 | 0 | 1 | 0% |
...
| usb-musb-sunxi-Avoid-enabling-host-side-code-on-SoCs-where-it-s.patch | 4 | 0 | 4 | 0% |
...
| usb-typec-fusb302-Set-the-current-before-enabling-pullups.patch | 2 | 0 | 2 | 0% |
| usb-typec-fusb302-Slightly-increase-wait-time-for-BC1.2-result.patch | 1 | 0 | 1 | 0% |
| usb-typec-fusb302-Update-VBUS-state-even-if-VBUS-interrupt-is-n.patch | 1 | 0 | 1 | 0% |
| usb-typec-tcpm-Fix-PD-devices-capabilities-registration.patch | 3 | 0 | 3 | 0% |
| usb-typec-tcpm-Improve-logs.patch | 4 | 0 | 4 | 0% |
| usb-typec-tcpm-Unregister-altmodes-before-registering-new-ones.patch | 1 | 0 | 1 | 0% |
...
**Disabled Patches:**
- 1 patches were disabled in series.conf (marked with '-' prefix)
- Only 443 enabled patches were analyzed
